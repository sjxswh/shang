				...
				<li v-for="data in dataList" :data="JSON.stringify(data)">
					...
					<div class="campaigns-content-main" :data="JSON.stringify(data)">
						<div class="campaigns-title" :data="JSON.stringify(data)">
							...
							<router-link to="/Offers" :data-cId="data.landerId" :data-name="data.landerName" @click="cOffer($event)" class="flowOffer">
								<span class="iconfont icon-gengduo"  :data-cId="data.landerId" :data-name="data.landerName"  @click="cOffer($event)"></span>
							</router-link>
						</div>
						<a @click="LinksHrf($event)" :data="JSON.stringify(data)">
